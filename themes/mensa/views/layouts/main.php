        ...
        <div id="topbar" data-options="region:'north'" class="noBorder text-white">
            <div class="row" style="margin-top:-10px">   
                <div class="col-md-6">
                    ...
                    <h5 style="margin-top:15px !important">Pedoman Baku</h5>
                </div>
                <div class="col-md-6" style="text-align:right">
                    ...
                    <?php if (!empty(Yii::app()->session['loginSession']['userName'])) : ?>
                        ...
                        <div id="mm" style="display:inline-block;">                   
                            <div><a href="#" onclick="open_password_form('<?php echo Yii::app()->request->baseUrl . '/site/changePassword'; ?>')"><span class="glyphicon glyphicon-edit"></span> Change Password</a></div>
                            <div><a href="<?php echo Yii::app()->request->baseUrl . '/site/logout'; ?>"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> Logout</a></div>
                        </div> 
                    <?php else : ?>
                        <span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp; 
                        <a href="<?php echo Yii::app()->request->baseUrl . '/site/login'; ?>" class="1-btn-text" 
