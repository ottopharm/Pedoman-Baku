...
<html>
    ...
    <body>
        ...
        ?>
        <div id="login-block">
            <img style="vertical-align:central;margin-bottom:5px" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/logo-harmoni.png">
            <p class="text-white" style="margin:3px;font-size:18px">Sign in to Harmoni.</p>	
            <?php
            ...
            <div id="pt">
                <a href="javascript:void(0)" class="icon-help" onclick="openResetDialog()"></a>
            </div>
            <p class="text-white">Cannot login? please contact administrator.<br>
                <a onclick="parent.location = 'http://portal.mensa-group.com'" style="color:#fff;cursor:pointer;">Back to Portal Mensa Group</a></p>
        </div>
